...
using Advent.Final.Core.Mapping;
using Advent.Final.DataAccess.Context;
using Advent.Final.Repositories.ImplementRepositories;
using AutoMapper;
...
namespace Advent.Final.Services
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Advent.Final.Services", Version = "v1" });
            });
